...
// auto InmemLogStore::start_index() const -> nuraft::ulong {
//     return start_idx_;
// }
...
//         global_logger->debug("Append app logs {}, content: {}, value type {}", idx, content, entry->get_val_type()); // 添加打印日志
...
//         global_logger->debug("Append other logs {}, content: {}, value type {}", idx, content, entry->get_val_type()); // 添加打印日志
//     }
...
//     InmemLogStore::log_entries(nuraft::ulong start, nuraft::ulong end)
// {
...
// nuraft::ptr<std::vector<nuraft::ptr<nuraft::log_entry>>>
//     InmemLogStore::log_entries_ext(nuraft::ulong start,
//                                      nuraft::ulong end,
...
// nuraft::ptr<nuraft::log_entry> InmemLogStore::entry_at(ulong index) {
//     nuraft::ptr<nuraft::log_entry> src = nullptr;
//     {   std::lock_guard<std::mutex> l(logs_lock_);
...
// ulong InmemLogStore::term_at(ulong index) {
//     ulong term = 0;
//     {   std::lock_guard<std::mutex> l(logs_lock_);
//         auto entry = logs_.find(index);
//         if (entry == logs_.end()) {
...
// nuraft::ptr<nuraft::buffer> InmemLogStore::pack(nuraft::ulong index, nuraft::int32 cnt) {
...
// void InmemLogStore::SetDiskDelay(raft_server* raft, size_t delay_ms) {
...
//                 &InmemLogStore::disk_emul_ea_, this );
//     }
// }
